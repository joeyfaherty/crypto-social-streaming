package home.spark.machinelearning.regression.linear
...
object LinearRegressionDataFrame {
  ...
  def main(args: Array[String]) {
    ...
    val spark = SparkSessionUtil.getSS("local", getClass.getName)
    ...
    val model: LinearRegressionModel = lir.fit(trainingDF)
